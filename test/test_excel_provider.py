...
class TestExcelProvider(unittest.TestCase):
    ...
    def test_get_projected_value(self):
        expected_data = pd.DataFrame([[0.476586932, 0.476586932, 0.464695628, 0.464754889, 0.466332369, 0.469162115,
                                      ...
                                      [1.698247435, 1.698247435, 1.590828573, 1.492707987, 1.403890821, 1.325025884,
