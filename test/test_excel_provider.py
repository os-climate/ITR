...
class TestExcelProvider(unittest.TestCase):
        ...
        self.company_info_at_base_year = pd.DataFrame(
            [
                [
                    ...
                    "North America",
                    "S1S2",
                    Q_(1.6982474347547, ureg("t CO2/GJ")),
                ...
                [
                    ...
                    "North America",
                    "S1S2",
                    Q_(0.476586931582279, ureg("t CO2/GJ")),
                ...
                [
                    ...
                    "Europe",
                    "S1S2",
                    Q_(0.22457393169277, ureg("t CO2/GJ")),
                    Q_(1.22472003e08, "MWh"),
                    "MWh",
                ],
            ],
    ...
    def test_temp_score_from_excel_data(self):
        comids = [
            ...
            "CH0198251305",
            "US1266501006",
            "FR0000120644",  # 'US24703L1035',
            "TW0002308004",  # 'FR0000120321', 'CH0038863350', 'US8356993076',
            # 'JP3401400001',
            "US6541061031",
            "GB0031274896",
            "US6293775085",
            # 'US7134481081', 'JP0000000001',
    ...
    def test_get_projected_production(self):
        expected_data_2025 = pd.Series(
            [122891226.4644476, 702142574.05294633, 146787786.599656552],
            index=self.company_ids,
            name=2025,
            dtype="pint[MWh]",
        ).astype("object")
    ...
    def test_get_company_data(self):
        ...
        companies = self.excel_provider.get_preprocessed_company_data(self.company_ids)
