...
class TestBaseProvider(unittest.TestCase):
    ...
    def test_get_company_data(self):
        ...
        self.assertAlmostEqual(company_1.ghg_s1, Q_(104827858.636039, 't CO2'))
        self.assertAlmostEqual(company_1.ghg_s2, Q_(204827858.636039, 't CO2'))
        self.assertAlmostEqual(company_1.ghg_s3, Q_(304827858.636039, 't CO2'))
