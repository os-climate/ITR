...
class TestTargets(unittest.TestCase):
    ...
    def test_target_netzero(self):
        ...
        expected_ag = pd.Series(PA_([0.596,
                                     0.53, 0.471, 0.419, 0.372, 0.33, 0.292, 0.259, 0.229, 0.202, 0.178,
                                     0.156, 0.137, 0.119, 0.104, 0.09, 0.077, 0.066, 0.055, 0.046, 0.037,
                                     0.03, 0.023, 0.018, 0.014, 0.01, 0.008, 0.005, 0.004, 0.002, 0.001,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_ah = pd.Series(PA_([0.596,
                                     0.516, 0.447, 0.387, 0.334, 0.289, 0.249, 0.206, 0.171, 0.141, 0.116,
                                     0.095, 0.08, 0.068, 0.057, 0.047, 0.039, 0.033, 0.027, 0.023, 0.018,
                                     0.014, 0.011, 0.009, 0.007, 0.005, 0.004, 0.003, 0.002, 0.001, 0.0,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_ai = pd.Series(PA_([0.596,
                                     0.559, 0.525, 0.493, 0.463, 0.435, 0.408, 0.383, 0.36, 0.338, 0.317,
                                     0.298, 0.224, 0.169, 0.126, 0.094, 0.069, 0.052, 0.038, 0.027, 0.019,
                                     0.012, 0.009, 0.007, 0.005, 0.004, 0.003, 0.002, 0.001, 0.001, 0.0,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_aj = pd.Series(PA_([0.596,
                                     0.544, 0.498, 0.455, 0.416, 0.381, 0.348, 0.305, 0.268, 0.235, 0.207,
                                     0.181, 0.142, 0.111, 0.086, 0.066, 0.051, 0.038, 0.029, 0.021, 0.014,
                                     0.009, 0.007, 0.005, 0.004, 0.003, 0.002, 0.002, 0.001, 0.001, 0.0,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
    ...
    def test_target_2030(self):
        ...
        expected_ag = pd.Series(PA_([0.596,
                                     0.559, 0.525, 0.493, 0.463, 0.435, 0.408, 0.383, 0.36, 0.338, 0.317,
                                     0.298, 0.278, 0.259, 0.242, 0.226, 0.211, 0.196, 0.183, 0.171, 0.16,
                                     0.149, 0.116, 0.089, 0.068, 0.051, 0.038, 0.027, 0.018, 0.011, 0.005,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_ah = pd.Series(PA_([0.596,
                                     0.544, 0.498, 0.455, 0.416, 0.381, 0.348, 0.305, 0.268, 0.235, 0.207,
                                     0.181, 0.163, 0.147, 0.132, 0.119, 0.107, 0.099, 0.091, 0.084, 0.078,
                                     0.072, 0.056, 0.043, 0.033, 0.025, 0.018, 0.013, 0.009, 0.005, 0.002,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_ai = pd.Series(PA_([0.596,
                                     0.577, 0.558, 0.54, 0.523, 0.506, 0.49, 0.475, 0.459, 0.445, 0.431,
                                     0.417, 0.363, 0.315, 0.274, 0.238, 0.207, 0.185, 0.165, 0.148, 0.132,
                                     0.118, 0.091, 0.071, 0.054, 0.041, 0.03, 0.021, 0.014, 0.009, 0.004,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_aj = pd.Series(PA_([0.596,
                                     0.544, 0.498, 0.455, 0.416, 0.381, 0.348, 0.305, 0.268, 0.235, 0.207,
                                     0.181, 0.169, 0.158, 0.147, 0.137, 0.128, 0.12, 0.112, 0.104, 0.097,
    ...
    def test_target_overlaps(self):
        ...
        expected_ai = pd.Series(PA_([0.596,
                                     0.577, 0.558, 0.54, 0.523, 0.506, 0.49, 0.475, 0.459, 0.445, 0.431,
                                     0.417, 0.345, 0.285, 0.236, 0.196, 0.162, 0.137, 0.117, 0.099, 0.084,
                                     0.072, 0.056, 0.043, 0.033, 0.025, 0.018, 0.013, 0.009, 0.005, 0.002,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
        expected_aj = pd.Series(PA_([0.596,
                                     0.544, 0.498, 0.455, 0.416, 0.381, 0.348, 0.305, 0.268, 0.235, 0.207,
                                     0.181, 0.178, 0.174, 0.171, 0.168, 0.164, 0.161, 0.158, 0.155, 0.152,
                                     0.149, 0.116, 0.089, 0.068, 0.051, 0.038, 0.027, 0.018, 0.011, 0.005,
                                     -0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
    ...
    def test_different_starting_dates_intensity(self):
        ...
        expected_aligned = pd.Series(PA_([0.396,
                                          0.361, 0.327, 0.293, 0.258, 0.224, 0.19, 0.158, 0.126, 0.095, 0.063,
                                          0.031, 0.031, 0.03, 0.03, 0.03, 0.029, 0.025, 0.022, 0.018, 0.014,
                                          0.01, 0.01, 0.009, 0.008, 0.008, 0.007, 0.007, 0.007, 0.006, 0.006,
                                          0.0], dtype='pint[CO2 * metric_ton / megawatt_hour]'),
                                index=range(2019,2051))
